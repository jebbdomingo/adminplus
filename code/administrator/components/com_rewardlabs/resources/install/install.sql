...
# Generation Time: 2017-09-08 05:07:25 +0000
# ************************************************************
...
CREATE TABLE `#__rewardlabs_cartitems` (
  ...
  PRIMARY KEY (`rewardlabs_cartitem_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `#__rewardlabs_cities` (
  ...
  PRIMARY KEY (`rewardlabs_city_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `#__rewardlabs_cities` WRITE;
/*!40000 ALTER TABLE `#__rewardlabs_cities` DISABLE KEYS */;

INSERT INTO `#__rewardlabs_cities` (`rewardlabs_city_id`, `name`, `province_id`)
VALUES
  (1,'Bangued',1),
  (2,'Boliney',1),
  (3,'Bucay',1),
...
CREATE TABLE `#__rewardlabs_employeeaccounts` (
  ...
  `created_by` int(11) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
  PRIMARY KEY (`rewardlabs_employee_id`),
  UNIQUE KEY `user_id` (`user_id`),
...
LOCK TABLES `#__rewardlabs_provinces` WRITE;
/*!40000 ALTER TABLE `#__rewardlabs_provinces` DISABLE KEYS */;

INSERT INTO `#__rewardlabs_provinces` (`rewardlabs_province_id`, `name`)
VALUES
  (1,'Abra'),
  (2,'Agusan del Norte'),
  (3,'Agusan del Sur'),
