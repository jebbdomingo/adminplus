...
class ComAdminplusTemplateHelperListbox extends ComKoowaTemplateHelperListbox
{
    /**
     * Account status
     * 
    ...
    {
        $options = array();
        $options[] = $this->option(array('label' => 'Pending', 'value' => ComNucleonplusModelEntityOrder::STATUS_PENDING));
        $options[] = $this->option(array('label' => 'Awaiting Payment', 'value' => ComNucleonplusModelEntityOrder::STATUS_PAYMENT));
        $options[] = $this->option(array('label' => 'Verified', 'value' => ComNucleonplusModelEntityOrder::STATUS_VERIFIED));
        $options[] = $this->option(array('label' => 'Processing', 'value' => ComNucleonplusModelEntityOrder::STATUS_PROCESSING));
        $options[] = $this->option(array('label' => 'Shipped', 'value' => ComNucleonplusModelEntityOrder::STATUS_SHIPPED));
        $options[] = $this->option(array('label' => 'Delivered', 'value' => ComNucleonplusModelEntityOrder::STATUS_DELIVERED));
        $options[] = $this->option(array('label' => 'Cancelled', 'value' => ComNucleonplusModelEntityOrder::STATUS_CANCELLED));
        $options[] = $this->option(array('label' => 'Completed', 'value' => ComNucleonplusModelEntityOrder::STATUS_COMPLETED));
