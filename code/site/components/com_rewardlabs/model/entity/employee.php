...
class ComRewardlabsModelEntityEmployee extends KModelEntityRow
{
    const _USER_GROUP_MANAGER_ = 6;

    /**
     * @var ComRewardlabsAccountingServiceEmployeeInterface
     */
    ...
    public function __construct(KObjectConfig $config)
    {
        ...
        if (!($service instanceof ComRewardlabsAccountingServiceEmployeeInterface))
        {
            throw new UnexpectedValueException(
                "Service $identifier does not implement ComRewardlabsAccountingServiceEmployeeInterface"
            );
        }
    ...
    {
        $config->append(array(
            'employee_service' => 'com:rewardlabs.accounting.employee'
        ));
    ...
    {
        $model = $this->getObject('com://site/rewardlabs.model.employeeaccounts');
    ...
    {
        $account = $this->getObject('com://site/rewardlabs.model.employeeaccounts')->user_id($userId)->fetch();
