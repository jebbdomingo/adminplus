 ...
 */
class ComRewardlabsModelEntityAccount extends KModelEntityRow
{
    ...
    {
        return $this->getObject('com://site/rewardlabs.model.orders')
            ->account_id($this->id)
            ->sort('id')
            ->direction('desc')
            ->limit($limit)
    ...
    {
        return $this->getObject('com://site/rewardlabs.model.accounts')->id($this->sponsor_id)->fetch();
    }
    ...
    public function save()
    {
        ...
        {
            $account = $this->getObject('com://site/rewardlabs.model.accounts')->user_id($this->user_id)->fetch();
    ...
    {
        $rewards = $this->getObject('com://site/rewardlabs.model.rewards')
            ->getDirectReferralBonus($this->id);

        $payouts = $this->getObject('com://site/rewardlabs.model.payouts')
