 ...
 */
class ComRewardlabsAccountingServiceSalesreceipt extends KObject implements ComRewardlabsAccountingServiceSalesreceiptInterface
{
    ...
    public function __construct(KObjectConfig $config)
    {
        ...
        if (!($service instanceof ComRewardlabsAccountingServiceTransferInterface))
        {
            throw new UnexpectedValueException(
                "Service $identifier does not implement ComRewardlabsAccountingServiceTransferInterface"
            );
        }
    ...
    public function recordSale(KModelEntityInterface $order)
    {
        ...
        else
        {
            ...
            $employee = $this->getObject('com:rewardlabs.model.employeeaccounts')->user_id($user->getId())->fetch();
        ...
        {
            if ($reward->type == ComRewardlabsModelEntityReward::REWARD_PACKAGE) {
