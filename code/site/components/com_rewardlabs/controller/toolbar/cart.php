...
class ComRewardlabsControllerToolbarCart extends ComKoowaControllerToolbarActionbar
{
    ...
    protected function _addReadCommands(KControllerContextInterface $context)
    {
        ...
        $account = $this->getObject('com://site/rewardlabs.model.accounts')->id($account_id)->fetch();
