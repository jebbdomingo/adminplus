                ...
                <? if (count($configs)): ?>
                    <? foreach ($configs as $config): ?>
                        <tr>
                            ...
                            <td>
                                <a data-k-tooltip='{"container":".k-ui-container","delay":{"show":500,"hide":50}}' data-original-title="<?= translate('View {title}', array('title' => escape($config->item))); ?>" href="<?= route('view=config&id='.$config->id); ?>">
                                        <?= escape($config->item); ?>
                                </a>
                            </td>
                        </tr>
