                ...
                <? if (count($payouts)): ?>
                    <? foreach ($payouts as $payout): ?>
                        <tr>
                            ...
                            <td>
                                <a data-k-tooltip='{"container":".k-ui-container","delay":{"show":500,"hide":50}}' data-original-title="<?= translate('View {title}', array('title' => escape($payout->account))); ?>" href="<?= route('view=account&id='.$payout->account); ?>">
                                        <?= escape($payout->account); ?>
                                </a>
                            </td>
