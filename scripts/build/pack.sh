...
# Clean up
rm -rf installer
rm -f com_rewardlabs_installer.zip
rm -f com_rewardlabs.zip
...
unzip -q com_rewardlabs.zip -d $payload_dir/rewardlabs
unzip -q joomlatools-framework.zip -d $payload_dir/framework

# zip it all up
zip -q -r com_rewardlabs_installer.zip installer
